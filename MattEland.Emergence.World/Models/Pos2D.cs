...
public struct Pos2D : IEquatable<Pos2D>
{
    ...
    /// </summary>
    [SuppressMessage("ReSharper", "UnusedMember.Global", Justification = "Used by serialization")]
    ...
    {
        return new Pos2D(_x - other._x, _y - other._y);
    }
    ...
    public Pos2D GetNeighbor(Direction direction)
    {
        switch (direction)
        {
            case Direction.Up: return Add(0, -1);
            case Direction.Right: return Add(1, 0);
            case Direction.Down: return Add(0, 1);
            case Direction.Left: return Add(-1, 0);
            default:
