...
namespace MattEland.Emergence.Engine.Level
{
    ...
    public class LevelData
    {
        ...
        public IEnumerable<GameObject> Objects => _cells.Values.SelectMany(c => c.Objects);
        ...
        public void MoveObject(GameObject obj, Pos2D newPos)
        {
        ...
        */
        ...
        public void RemoveAllObjects(Func<GameObject, bool> matcherFunc)
        {
            foreach (var cell in Cells)
            {
        ...
        public IEnumerable<GameObject> GetTargetsAtPos(Pos2D pos)
        {
            var cell = GetCell(pos);
