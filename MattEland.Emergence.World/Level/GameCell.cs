...
namespace MattEland.Emergence.Engine.Level
{
    ...
    {
        private readonly ICollection<GameObject> _objects;
        ...
        public IEnumerable<GameObject> Objects => _objects; // TODO: Only serialize this when there are objects present.
